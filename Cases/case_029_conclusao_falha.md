# Playbook: Caso 029: Conclusao - Falha
...
Falha ao tentar avançar a partir de conclusao. O sistema entrou em estado Delayed para proteção.

## 3. Fluxo Esperado
```mermaid
graph TD
    A[Conclusao] -->|Ação: Erro de sistema / Timeout| B[Delayed]
```
