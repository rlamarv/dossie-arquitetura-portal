...
Falha ao tentar avançar a partir de lead. O sistema entrou em estado Delayed para proteção.

## 3. Fluxo Esperado
```mermaid
graph TD
    A[Lead] -->|Ação: Erro de sistema / Timeout| B[Delayed]
```
